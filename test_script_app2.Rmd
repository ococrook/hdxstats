...
data_diff <- assay(data_selection)[,6] - assay(data_selection)[,3]

sigplots <- manhattanplot(params = results$functional_analysis,
                          sequences = rownames(assay(hdx_data_nointercept)), 
