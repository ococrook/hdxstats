...
First we fit the parametric model to the data.

```{r,}
res <- differentialUptakeKinetics(object = MBPqDF[,1:100],
                                  feature = rownames(MBPqDF)[[1]][37],
                                  start = list(a = NULL, b = 0.0001,  d = NULL, p = 1))
```
```
