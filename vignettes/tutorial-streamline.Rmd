...
hdx_data <- extract_hdx_data(csv_filepath, parameter_file = "../inst/extdata/MBP_qDF.hdxp")
```
...
hdx_data <- extract_hdx_data(csv_filepath, parameter_file = "../inst/extdata/N64184_1a2_state.hdxp")
```
...
```{r}
# INPUT
pdb_filepath <- "/home/sanjuan/research/hdxstats/vignettes/data/5edv_chainA_clean_renumbered.pdb"
fasta_filepath <- system.file("extdata", "HOIP.txt", package = "hdxstats", mustWork = TRUE)
...
```{r, fig.height = 12, fig.width = 50, fig.align = "center"}
pheatmap(t(assay(hdx_data)),
         cluster_rows = FALSE, 
         cluster_cols = FALSE,
         color = brewer.pal(n = 9, name = "BuPu"),
