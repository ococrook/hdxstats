...
R markdown notebook to generate a pretty heatmap plot (pheatmap) from all the protection/deprotection probability data for all binding antibody conditions of HOIP-RBR.
...
rownames(heatmap_matrix) <- format(paste(df$aa, formatC(df$resnum, width=3, flag="0"), sep="-"), justify="centre")
```
